...
import ca.paulshin.glass.bible.utils.BaseAsyncTask;
...
public abstract class BaseProgressActivity extends BaseActivity {
    ...
    ca.paulshin.glass.bible.view.ProgressBar vProgressBar;
    ...
    protected void initViews() {
    	vProgressBar = (ca.paulshin.glass.bible.view.ProgressBar)findViewById(R.id.progress_bar);
        vProgressText = (TextView)findViewById(R.id.progress_text);
        vGracePeriodText = (TextView)findViewById(R.id.grace_period_text);
    }
